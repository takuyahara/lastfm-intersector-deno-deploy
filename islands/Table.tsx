import { sprintf } from "https://deno.land/std@0.186.0/fmt/printf.ts";
import { Artist } from "../routes/api/similarartists/[artist].ts";
...
export default function Table(props: FormProps) {
